...
class Tracking3D(Observation):
    ...
    def space(self) -> gym.spaces.Box:
        low = self.intervention.tracking3d_space.low
        high = self.intervention.tracking3d_space.high
    ...
    def _calculate_tracking_state(self) -> np.ndarray:
        tracking = self.intervention.tracking3d
